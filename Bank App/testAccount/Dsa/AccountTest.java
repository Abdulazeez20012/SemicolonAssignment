...
public class AccountTest {
    ...
    public void test_To_Withdraw_With_An_WrongPin() {
        ...
        assertNotNull(exception);
        assertTrue(exception.getMessage().contains("Wrong PIN")); // Corrected to assertTrue
    }
    ...
    public void testUpdatePinWithIncorrectCurrentPin() {
        ...
        assertNotNull(exception);
        assertTrue(exception.getMessage().contains("Current PIN is incorrect")); // Corrected to assertTrue

        account.deposit(200);
        account.withdraw(100, pin); // Corrected pin used for withdrawal
