...
public class CompoundInterestCalculator {
    public static void main(String[] args) {
        ...
        System.out.print("Enter annual interest rate (as decimal, e.g., 5% = 0.05): ");
        double interestRate = sc.nextDouble();
        

        System.out.print("Enter interest rate variance range (e.g., 0.02 for ±2%): ");
        double variance = sc.nextDouble();
        
        
        System.out.print("Enter compound frequency (times per year, e.g., 1 for annually, 4 for quarterly): ");
